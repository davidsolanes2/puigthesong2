...
import com.puigthesong.app.repository.ArtistRepository;
...
import static com.puigthesong.app.web.rest.TestUtil.createFormattingConversionService;
import static org.assertj.core.api.Assertions.assertThat;
import static org.hamcrest.Matchers.hasItem;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import com.puigthesong.app.domain.enumeration.Sex;
import com.puigthesong.app.domain.enumeration.Status;
/**
...
public class ArtistResourceIntTest {
    ...
    public void createArtist() throws Exception {
        ...
        assertThat(testArtist.getDeathDate()).isEqualTo(DEFAULT_DEATH_DATE);
    ...
    public void updateArtist() throws Exception {
        ...
        assertThat(testArtist.getDeathDate()).isEqualTo(UPDATED_DEATH_DATE);
